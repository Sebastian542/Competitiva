    ...
    static class Grafo{
        ...
        public void printMst( Resultado [] resultado ) {
            ...
            for (int i = 1; i <= vertices; i++) {
            	...
            	String peso2=  sc.nextLine();

            	
            	int coordenadai=sc.nextInt();
            	int coordenadafi=sc.nextInt();
            	int peso=sc.nextInt();
            	
            	resultado[i].peso=peso;
             //   System.out.println("Arista " + i + " - " + resultado[i].padre + " peso: " + resultado[i].peso);
                
                total_coste_min +=resultado[i].peso;
            }
            if(total_coste_min==0) {
                System.out.println("Case #"+j+": unreachable");

            }else {
            System.out.println("Case #"+j+": "+ total_coste_min);
